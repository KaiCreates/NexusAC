...
PERMISSIONS: dict[str, tuple[str, ...]] = {
    ...
    "owner": ("warn", "kick", "ban", "freeze", "screenshot", "unban", "setting", "entity", "detector", "punish", "webhook"),
    "administrator": ("warn", "kick", "ban", "freeze", "screenshot", "unban", "setting", "entity", "detector", "punish", "webhook"),
